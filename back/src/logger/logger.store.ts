...
import { ELogLevel, LoggerService } from './logger.service';
...
export class LoggerStore {
  ...
  constructor(
    ...
    private base_ctx: { [key: string]: unknown } = {}
  ) {}
  ...
  public info(message: unknown, context: object = {}) {
    this.addLog(ELogLevel.info, { message, context });
  }

  public warn(message: unknown, context: object = {}) {
    this.addLog(ELogLevel.warn, { message, context });
  }

  public error(message: unknown, trace?: string, context: object = {}) {
